            ...
            <div className="row d=flex justify-content-center vh-100 align-items-center">
                <div className="col-lg-5 shadow bg-light p-4 rounded">
                    ...
                    <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-8">    
                        <input type='text' value={name} onChange={e => setName(e.target.value)} placeholder='Name' className="form-control mb-4" required />
                        ...
                        <button type='submit' className="btn btn-primary btn-raised w-100" disabled={loading || !name || !email || !password}>
